...
We have created a number of acceptance tests for the Berlin Clock and your challenge is to get them passing. Additionally, please make sure your solution is accompanied by comments in commit messages that describe a step-by-step refactorings, so we can understand the way you were thinking.
...
Please ensure that you are familiar with our values in the instructions project.  They are important to us. (OpsIT-instructions.zip)